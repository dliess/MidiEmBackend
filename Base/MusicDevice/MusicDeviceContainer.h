...
public:
   ...
   CB_SIGNAL(SoundDevParamChanged, util::Identifiable::UUID, int, int, float,
             float);
   CB_SIGNAL(ControllerDevEventOccured, util::Identifiable::UUID,
             const controller::Event&);
   CB_SIGNAL(ControllerDevEventOccuredUI, util::Identifiable::UUID,
             const controller::Event&);
   ...
   CB_SIGNAL(LFOMultiplierExpChanged, util::Identifiable::UUID, int, int,
             uint32_t);
   CB_SIGNAL(EnginePresetChanged, const std::string&, int, const std::string&);
   CB_SIGNAL(ActualPresetChanged, util::Identifiable::UUID, int,
             const std::string&);
};
