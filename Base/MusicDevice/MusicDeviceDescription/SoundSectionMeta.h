...
template<>
inline auto registerMembers<base::musicDevice::description::sound::midisysex::Bytes>()
{
   return members(
      member("values", &base::musicDevice::description::sound::midisysex::Bytes::values)
   );
}
...
template<>
inline auto registerMembers<base::musicDevice::description::sound::midisysex::PatchNameStr>()
{
   return members(
      member("size", &base::musicDevice::description::sound::midisysex::PatchNameStr::size)
   );
}

template<>
inline auto registerMembers<base::musicDevice::description::sound::midisysex::PatchCategory>()
{
   return members(
      member("size", &base::musicDevice::description::sound::midisysex::PatchCategory::size)
   );
}

template<>
inline auto registerMembers<base::musicDevice::description::sound::midisysex::PatchGenre>()
{
   return members(
      member("size", &base::musicDevice::description::sound::midisysex::PatchGenre::size)
   );
}

template<>
inline auto registerMembers<base::musicDevice::description::sound::midisysex::Reserved>()
{
   return members(
      member("size", &base::musicDevice::description::sound::midisysex::Reserved::size)
   );
}

template<>
inline auto registerMembers<base::musicDevice::description::sound::midisysex::ParameterLowRes>()
{
   return members(
      member("component", &base::musicDevice::description::sound::midisysex::ParameterLowRes::component),
      member("parameter", &base::musicDevice::description::sound::midisysex::ParameterLowRes::parameter)
   );
}

template <>
inline auto getClassNameOrIndex<base::musicDevice::description::sound::midisysex::Bytes>(int i) noexcept
{
   return "Bytes";
}
template <>
inline auto getClassNameOrIndex<base::musicDevice::description::sound::midisysex::VoiceIdx>(int i) noexcept
{
   return "VoiceIdx";
}
template <>
inline auto getClassNameOrIndex<base::musicDevice::description::sound::midisysex::PatchNameStr>(int i) noexcept
{
   return "PatchNameStr";
}
template <>
inline auto getClassNameOrIndex<base::musicDevice::description::sound::midisysex::PatchCategory>(int i) noexcept
{
   return "PatchCategory";
}
template <>
inline auto getClassNameOrIndex<base::musicDevice::description::sound::midisysex::PatchGenre>(int i) noexcept
{
   return "PatchGenre";
}
template <>
inline auto getClassNameOrIndex<base::musicDevice::description::sound::midisysex::Reserved>(int i) noexcept
{
   return "Reserved";
}
template <>
inline auto getClassNameOrIndex<base::musicDevice::description::sound::midisysex::ParameterLowRes>(int i) noexcept
{
