...
std::optional<float> MelodicComponent::getParameterValue(
...
void MelodicComponent::setParameterValue(
...
MelodicComponent::parameterDescription(int parameterIdx) const
{
   if (m_pSoundDevice)
   {
