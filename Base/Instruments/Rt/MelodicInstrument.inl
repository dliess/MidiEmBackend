#ifndef MELODIC_INSTRUMENT_RT_INL
#define MELODIC_INSTRUMENT_RT_INL

#include "MelodicInstrument.h"

namespace base::instruments::rt
{
inline void MelodicInstrument::RtData::incrementVoiceIndex(size_t maxSize) noexcept
{
   if(maxSize > 0)
   {
      ++m_currentVoiceIndex;
...
#endif   // MELODIC_INSTRUMENT_RT_INL
