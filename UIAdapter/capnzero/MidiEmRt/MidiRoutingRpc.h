...
public:
	...
	void setSpecializedRouting(const ::capnzero::TextView& from, const ::capnzero::TextView& to, ::capnzero::UInt8 sourceChannel, ::capnzero::UInt8 destChannel, ::capnzero::UInt8 enable) override;
private:
